...
public class TC03_SearchProductDiscountPrice extends BaseClass {

	@Test
	public  void SearchProductByDiscountPrice() throws Throwable 
	{
		...
		System.out.println(ProductCpg.getSearchItem_Discountprice().size());

		//Step:5 fetch the  item and print
		
		ProductCpg.printSearchItemDiscountprice();
